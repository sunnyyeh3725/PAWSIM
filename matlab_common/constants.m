...
MOMENTUM_TW81 = 3; %%% Takano and Wurtele (1981)
...
%%% Pressure solve mode identifiers
PRESSURE_SOR = 0; %%% Distributed successive over relaxation
PRESSURE_MG_GATHER = 1; %%% Gathered multigrid
PRESSURE_MG_PARALLEL = 2; %%% Parallelized multigrid

%%% File system
exec_name = 'PAWSIM.exe';
